...
import com.topjava.graduation.exception.*;
...
import static com.topjava.graduation.exception.ErrorType.*;
...
// more specific first
            ...
            put(VotingRestrictionsException.class, VOTING_RESTRICTIONS);
    ...
    ProblemDetail bindException(BindException ex, HttpServletRequest request) {
        ...
        return createProblemDetail(ex, path, BAD_DATA, "BindException", Map.of("invalid_params", invalidParams));
    }
